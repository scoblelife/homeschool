    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
      ...
      {activeSession ? (
        ...
        <div className="text-center py-6">
          ...
          <button
            onClick={handleStart}
            className="mt-4 inline-flex items-center px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-medium"
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
                    ...
                    <div>
                      ...
                      <Listbox value={selectedStudentId} onChange={setSelectedStudentId}>
                        <div className="relative">
                          <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            <Listbox.Options className="absolute z-10 w-full py-1 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-auto">
                              {students.map((student) => (
                                <Listbox.Option
                                  ...
                                  value={student.id}
                                  className={({ active }) =>
                                    `cursor-pointer select-none py-2 px-3 ${active ? 'bg-indigo-50 text-indigo-900' : 'text-gray-900'}`
                                  }
                                >
                                  {student.name}
                                </Listbox.Option>
