...
export function AIWeeklySummary({
  ...
  const handleGenerateSummary = async () => {
    ...
    try {
      ...
      setLocalError(err instanceof Error ? err.message : 'Failed to generate summary')
    }
  }
    ...
    return (
      <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span>AI insights available with API key. Configure in Settings.</span>
        </div>
      </div>
    )
  }
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-100 overflow-hidden">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-purple-900">AI Weekly Summary</span>
            </div>
            <svg
          ...
          <div className="flex items-center justify-center gap-2">
            {isGenerating ? (
              ...
              <>
                ...
                <span className="text-gray-500">No activities to summarize</span>
              </>
            ) : (
              <>
                <span className="text-lg">✨</span>
                <span className="text-purple-700 font-medium">Generate AI Summary</span>
              </>
            )}
          </div>
        </button>
