...
export const LEARNING_RESOURCES: LearningResource[] = [
  // VIDEO LEARNING
  {
    id: 'khan-academy',
    name: 'Khan Academy',
    description: 'Free video lessons and practice exercises covering math, science, history, and more.',
    ...
    icon: '🎓',
    features: ['Video lessons', 'Practice exercises', 'Progress tracking', 'Parent dashboard']
  },
  {
    id: 'khan-academy-kids',
    name: 'Khan Academy Kids',
    description: 'Free, fun educational app for children ages 2-8 with thousands of activities.',
    url: 'https://learn.khanacademy.org/khan-academy-kids/',
    category: 'game',
    subjects: ['reading', 'math', 'social-emotional'],
    gradeLevels: ['pre-k', 'k', '1st', '2nd'],
    isFree: true,
    suggestedActivityType: 'game',
    suggestedDuration: 20,
    icon: '🧒',
    features: ['Interactive activities', 'Read-along books', 'Math games', 'Social-emotional learning']
  },
  {
    id: 'brainpop',
    name: 'BrainPOP',
    ...
    category: 'video',
    subjects: ['science', 'math', 'english', 'social-studies', 'health', 'art', 'technology'],
    gradeLevels: ['k', '1st', '2nd', '3rd', '4th', '5th', '6th', '7th', '8th'],
    isFree: false,
    suggestedActivityType: 'video',
    suggestedDuration: 15,
    icon: '🎬',
    features: ['Animated videos', 'Quizzes', 'Vocabulary', 'Creative activities']
  },
  {
    id: 'brainpop-jr',
    name: 'BrainPOP Jr.',
    ...
    icon: '🎥',
    features: ['Age-appropriate content', 'Annie and Moby characters', 'Games', 'Activities']
  },
  {
    id: 'crash-course-kids',
    name: 'Crash Course Kids',
    description: 'YouTube science videos for elementary students from the Crash Course team.',
    ...
    suggestedDuration: 10,
    icon: '🔬',
    features: ['YouTube channel', 'Earth science', 'Life science', 'Physical science']
  },
  ...
  // READING RESOURCES
  {
    id: 'starfall',
    name: 'Starfall',
    description: 'Free reading program for early learners with phonics activities.',
    ...
    suggestedDuration: 20,
    icon: '⭐',
    features: ['Phonics', 'Read-along books', 'Songs', 'Interactive activities']
  },
  {
    id: 'epic',
    name: 'Epic!',
  ...
  },
  {
    ...
    description: 'Free read-aloud videos featuring celebrities reading children\'s books.',
  ...
  },
  {
    ...
    gradeLevels: ['4th', '5th', '6th', '7th', '8th', '9th', '10th', '11th', '12th'],
    isFree: true,
    suggestedActivityType: 'reading',
    suggestedDuration: 30,
    icon: '🎧',
  ...
  // MATH PRACTICE
  {
    id: 'ixl',
    name: 'IXL',
    description: 'Personalized math and language arts practice with comprehensive reporting.',
    ...
    suggestedDuration: 20,
    icon: '📈',
    features: ['Adaptive practice', 'Detailed analytics', 'Standards-aligned', 'Awards']
  },
  {
    id: 'prodigy',
    name: 'Prodigy Math',
    description: 'Free math game where kids practice math to cast spells and battle monsters.',
    ...
    suggestedDuration: 30,
    icon: '🧙',
    features: ['RPG-style game', 'Adaptive questions', 'Parent dashboard', 'Standards-aligned']
  },
  {
    id: 'zearn',
    name: 'Zearn',
    description: 'Free math curriculum with digital lessons and independent practice.',
    ...
    suggestedDuration: 30,
    icon: '🔢',
    features: ['Video lessons', 'Digital problems', 'Manipulatives', 'Progress tracking']
  },
  {
    id: 'coolmath',
    name: 'Coolmath Games',
  ...
  // SCIENCE RESOURCES
  {
    ...
    description: 'Science videos, articles, games, and activities about animals and nature.',
  ...
  },
  {
    ...
    gradeLevels: ['3rd', '4th', '5th', '6th', '7th', '8th', '9th', '10th', '11th', '12th'],
    isFree: true,
    suggestedActivityType: 'hands_on',
    suggestedDuration: 25,
    icon: '🔭',
    features: ['Physics simulations', 'Chemistry simulations', 'Math simulations', 'Research-based']
  },
  {
    id: 'nasa-kids',
    name: 'NASA Kids\' Club',
  ...
  },
  {
    id: 'scratch',
    name: 'Scratch',
    description: 'Free coding platform from MIT for kids to create stories, games, and animations.',
  ...
  },
  {
    ...
    suggestedDuration: 30,
    icon: '💻',
    features: ['Hour of Code', 'CS courses', 'Progress tracking', 'Certificates']
  },
  ...
  // ART & MUSIC
  {
    ...
    description: 'YouTube channel with step-by-step drawing tutorials for kids.',
  ...
  },
  {
    ...
    description: 'Fun experiments to learn about music through interactive play.',
    ...
    suggestedDuration: 15,
    icon: '🎵',
    features: ['Sound experiments', 'Rhythm tools', 'Melody makers', 'Visual music']
  },
  ...
  // FOREIGN LANGUAGE
  {
    ...
    gradeLevels: ['1st', '2nd', '3rd', '4th', '5th', '6th', '7th', '8th', '9th', '10th', '11th', '12th'],
    isFree: true,
    suggestedActivityType: 'reading',
    suggestedDuration: 15,
    icon: '🦉',
    features: ['Many languages', 'Gamified', 'Bite-sized lessons', 'Progress tracking']
  }
]
