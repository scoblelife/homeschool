  ...
  if (aggregateStats) {
    aggregateStats.percentage =
      aggregateStats.totalDays > 0
        ? Math.round((aggregateStats.schoolDays / aggregateStats.totalDays) * 100)
        : 0
  }
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-green-600 dark:text-green-400">School Days</span>
          </div>
        ...
        <div className="bg-red-50 dark:bg-red-900/30 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-red-600 dark:text-red-400">Absences</span>
          </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-blue-600 dark:text-blue-400">Attendance Rate</span>
          </div>
          <p className={`text-2xl font-bold ${getPercentageColor(displayStats.percentage)}`}>
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          <strong>Note:</strong> Many states require tracking of instructional days.
          Nevada requires notification of intent to homeschool but has no minimum day
          requirement. Check your state's specific requirements in Settings.
        </p>
      </div>
    </div>
  )
