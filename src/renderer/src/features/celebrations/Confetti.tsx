...
const COLORS = ['#f43f5e', '#ec4899', '#a855f7', '#8b5cf6', '#6366f1', '#3b82f6', '#0ea5e9', '#14b8a6', '#22c55e', '#eab308', '#f97316']
...
export function ConfettiBurst({ x, y, active }: { x: number; y: number; active: boolean }): JSX.Element | null {
  const [pieces, setPieces] = useState<ConfettiPiece[]>([])
