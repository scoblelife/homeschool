...
export function generateMilestoneCertificateHTML(data: MilestoneCertificateData): string {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function generateGradeCertificateHTML(data: GradeCertificateData): string {
