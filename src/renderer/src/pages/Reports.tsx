    ...
    <div className="p-8">
      ...
      {!selectedStudentId ? (
        <div className="card text-center py-12">
          <p className="text-gray-500">Select a student from the sidebar to view reports.</p>
        </div>
      ) : (
        <>
          {/* Date Range Selector */}
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div className="card">
                  ...
                  <div className="text-xl font-bold text-gray-900 mt-2">{selectedStudent?.name}</div>
                  <div className="text-sm text-gray-500 capitalize">{selectedStudent?.gradeLevel}</div>
                </div>
                <div className="card">
                  <div className="text-sm font-medium text-gray-500">Total Activities</div>
                  <div className="text-3xl font-bold text-gray-900 mt-2">{totalActivities}</div>
                </div>
                <div className="card">
                  <div className="text-sm font-medium text-gray-500">Total Hours</div>
                  <div className="text-3xl font-bold text-gray-900 mt-2">{totalHours}</div>
                </div>
                <div className="card">
                  <div className="text-sm font-medium text-gray-500">Active Days</div>
                  <div className="text-3xl font-bold text-gray-900 mt-2">{dailySummaries.length}</div>
                </div>
              </div>
              ...
              <div className="card mb-8">
                ...
                {activitySummary.length === 0 ? (
                  <p className="text-gray-500 text-sm">No activities in this date range.</p>
                ) : (
                      ...
                      return (
                        <div key={summary.subjectId}>
                          <div className="flex items-center justify-between mb-1">
                            <span className="font-medium text-gray-900">{summary.subjectName}</span>
