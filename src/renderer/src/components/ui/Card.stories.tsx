...
export const WithHeader: Story = {
  render: () => (
    <Card>
      ...
      <CardContent>
        <p className="text-sm text-gray-600">You've completed 3 activities today, totaling 2 hours of learning time.</p>
      </CardContent>
    </Card>
  ),
}
...
export const WithFooter: Story = {
  render: () => (
    <Card>
      ...
      <CardContent>
        <p className="text-sm text-gray-600">Log a new learning activity for your student.</p>
      </CardContent>
      <CardFooter>
...
export const PaddingNone: Story = {
  args: {
    padding: 'none',
    children: <div className="p-4 bg-fuchsia-50">Content with no card padding</div>,
  },
}
      ...
      <CardContent>
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mt-1">Charlotte's Web - Chapter 3</p>
            <div className="flex items-center gap-2 mt-2">
              <Badge variant="success" size="sm">30 min</Badge>
