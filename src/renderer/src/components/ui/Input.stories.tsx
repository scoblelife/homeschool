...
export const FormFieldWithHint: InputStory = {
  render: () => (
    <FormField label="Notes" htmlFor="notes" hint="Optional additional details about the activity">
...
export const FormFieldWithError: InputStory = {
  render: () => (
    <FormField label="Email" htmlFor="email" required error="Please enter a valid email address">
...
export const CompleteForm: InputStory = {
  render: () => (
    <form className="space-y-4 max-w-md">
      ...
      <FormField label="Description" htmlFor="desc" hint="Describe what was learned">
