...
module.exports = [
  ...
  ...tseslint.configs.recommended,
  {
    ...
    rules: {
      ...
      // Design System Rules
      // NOTE: Phase 5 complete - all 20 pages migrated to design system.
      // Rules enforced as errors to prevent regressions.
      // See DESIGN_SYSTEM.md for component library and migration guide.
