  ...
  switch (state) {
    case "synced":
      return {
        ...
        bgColor: "bg-status-successLight",
        icon: "check",
      };
    case "syncing":
      return {
      ...
      return (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M18.364 5.636a9 9 0 010 12.728m-3.536-3.536a4 4 0 010-5.656M6.343 17.657a9 9 0 010-12.728m3.536 3.536a4 4 0 010 5.656"
          />
          <line
            x1="4"
            y1="4"
          ...
          <Dialog.Panel className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                ...
                <span
                  className={`flex items-center gap-2 px-2 py-1 rounded-full ${statusInfo.bgColor} ${statusInfo.color} text-sm font-medium`}
                >
                    ...
                    {status.connectedPeers.map((peer) => (
                      ...
                      >
                        ...
                        <span className="text-gray-900">
                          {peer.deviceName || peer.deviceId.slice(0, 8)}
                        </span>
                      </li>
                    ))}
                  </ul>
              ...
              {/* Error Message */}
              {status.errorMessage && (
                <div className="p-3 rounded-lg bg-status-errorLight text-status-errorDark text-sm">
              ...
              {status.pendingEvents > 0 && (
                <div className="flex items-center justify-between p-3 rounded-lg bg-status-warningLight">
                  <span className="text-status-warningDark">
                    Pending Changes
                  </span>
                  <span className="text-status-warningDark font-medium">
