...
export function CurriculumRecommendations() {
  ...
  const priceOptions: Array<{
    value: CurriculumRecommendation["priceRange"];
    label: string;
  }> = [
  ...
  const categoryOptions: Array<{
    value: CurriculumRecommendation["category"];
    label: string;
  }> = [
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <select
          value={selectedGrade || ""}
          onChange={(e) =>
            setSelectedGrade((e.target.value as GradeLevel) || null)
          }
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
            bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"
        >
        ...
        <select
          ...
          onChange={(e) =>
            setSelectedCategory(
              (e.target.value as CurriculumRecommendation["category"]) || null,
            )
          }
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
            bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"
        ...
        <select
          ...
          onChange={(e) =>
            setSelectedStyle(
              (e.target.value as CurriculumRecommendation["style"]) || null,
            )
          }
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
            bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"
        ...
        <select
          ...
          onChange={(e) =>
            setSelectedPrice(
              (e.target.value as CurriculumRecommendation["priceRange"]) ||
                null,
            )
          }
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          <span
            className={`px-2 py-0.5 text-xs rounded-full ${categoryColors[recommendation.category]}`}
          >
            {categoryLabels[recommendation.category]}
          </span>
          <span
            className={`px-2 py-0.5 text-xs rounded-full ${priceColors[recommendation.priceRange]}`}
          >
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 mb-3">
          Grades: {recommendation.gradeLevels[0]} -{" "}
          {recommendation.gradeLevels[recommendation.gradeLevels.length - 1]}
        </div>
