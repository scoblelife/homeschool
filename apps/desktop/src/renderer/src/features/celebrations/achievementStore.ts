...
export const ACHIEVEMENT_DEFINITIONS: Omit<Achievement, "unlockedAt">[] = [
  ...
  },
  {
    ...
    description: "250 hours of learning",
    icon: "🏅",
    category: "hours",
    threshold: 250,
  },
  ...
  },
  {
    ...
    description: "1000 hours of learning",
    icon: "👑",
    category: "hours",
    threshold: 1000,
  },
  ...
  },
  {
    id: "activities-1000",
    name: "Unstoppable",
    description: "1000 activities completed",
    icon: "🚀",
    category: "activities",
    threshold: 1000,
  },
  ...
  },
  {
    id: "books-100",
    name: "Library Legend",
    description: "100 books finished",
    icon: "📚",
    category: "books",
    threshold: 100,
  },
