...
// Student events
export async function emitStudentCreated(
  data: StudentCreatedData,
): Promise<void> {
  await syncManager.emitEvent("student.created", toRecord(data));
}

export async function emitStudentUpdated(
...
// Activity events
export async function emitActivityLogged(
  data: ActivityLoggedData,
): Promise<void> {
...
// Milestone events
export async function emitMilestoneCreated(
  data: MilestoneCreatedData,
): Promise<void> {
  await syncManager.emitEvent("milestone.created", toRecord(data));
}

export async function emitMilestoneUpdated(
  data: MilestoneUpdatedData,
): Promise<void> {
...
// Field trip events
export async function emitFieldTripCreated(
  data: FieldTripCreatedData,
): Promise<void> {
  await syncManager.emitEvent("fieldTrip.created", toRecord(data));
}

export async function emitFieldTripUpdated(
  data: FieldTripUpdatedData,
): Promise<void> {
...
// Subject events
export async function emitSubjectCreated(
  data: SubjectCreatedData,
): Promise<void> {
  await syncManager.emitEvent("subject.created", toRecord(data));
}

export async function emitSubjectUpdated(
  data: SubjectUpdatedData,
): Promise<void> {
